...
/*
#include <stdlib.h>
#cgo CFLAGS: -I /code/myselfgo/src/myproject/tair_http_server/c -I /code/myselfgo/src/myproject/tair_http_server/c/include/tbnet -I /code/myselfgo/src/myproject/tair_http_server/c/include/tbsys
#cgo LDFLAGS: -L /code/myselfgo/src/myproject/tair_http_server/c/lib -ltbsys -ltbnet -ltair_clib
#include "tair_clib.h"
*/
import "C"
